...
const Bodyhero = () => {
  return (
    <div className="w-full min-h-screen bg-bgDark flex items-center py-0">
        <div className="w-full max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 px-4 md:px-12">
          {/* Columna izquierda */}
          <div className="flex flex-col items-center md:items-start justify-center space-y-6 md:space-y-8">
            {/* Nombre */}
            <div className="text-center md:text-left w-full">
              <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold text-title tracking-tight leading-tight">
                Hairon
                <br />
            ...
            <div className="flex flex-col items-center md:items-start space-y-4 md:space-y-6 w-full">
              <span className="text-lg sm:text-xl md:text-2xl text-primary font-semibold text-center md:text-left">
              ...
              <div className="flex gap-4 md:gap-6 flex-wrap justify-center">
                {["GitHub", "LinkedIn", "Twitter", "Instagram"].map((link) => (
                  <a
                    ...
                    className="text-title text-base md:text-lg hover:text-primary transition-colors relative after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-primary hover:after:w-full after:transition-all"
                  >
                    {link}
                  </a>
                ))}
          ...
          <div className="flex justify-center items-center mt-8 md:mt-0">
            <figure className="relative m-0 w-full max-w-[300px] md:max-w-[400px]">
              <img
                src={imgHero}
                alt="Hairon Chávez"
                className="w-full h-auto rounded-xl shadow-lg transition-all duration-300 hover:-translate-y-2"
              />
