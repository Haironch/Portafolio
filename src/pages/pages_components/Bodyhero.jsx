...
import ContactModal from "../pages_components/ContactModal"; // Asegúrate de ajustar la ruta según tu estructura

const Bodyhero = () => {
  return (
    <div className="w-full min-h-screen bg-bgDark flex items-center py-4 px-2 sm:py-0">
      <div className="w-full max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 px-2 sm:px-4 md:px-12">
        {/* Columna izquierda */}
        <div className="flex flex-col items-center md:items-start justify-center space-y-4 md:space-y-8">
          {/* Nombre */}
        ...
        <div className="flex justify-center items-center mt-6 md:mt-0">
          <figure className="relative m-0 w-full max-w-[250px] sm:max-w-[300px] md:max-w-[400px]">
            <img
              src={imgHero}
              alt="Hairon Chávez"
